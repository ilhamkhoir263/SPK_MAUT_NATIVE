...
<html lang="en">
    <head>
        ...
        <title>Kelompok Tani Tunas Baru</title>
    ...
    <body class="bg-gradient-transparent">
        ...
        <Center>
				<div class="col-xl-3 col-lg-5 col-md-5 mt-5">
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            ...
                                            <h1 class="h4 text-gray-900 mb-4"><img src="assets/img/logo.png" width="40%"><br>Kelompok Tani Tunas Baru</h1>
                                        </div>
										<?php if(!empty($errors)): ?>
